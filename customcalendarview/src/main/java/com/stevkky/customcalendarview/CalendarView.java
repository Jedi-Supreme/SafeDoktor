...
public class CalendarView extends LinearLayout {
    ...
    private TextView tv_prev, tv_next;
    ...
    private int tv_prevSrc;
    private int tv_nextSrc;
    ...
    private CalendarView(Context context, boolean isDatePicker, int headerColor, int headerLabelColor,
        ...
        tv_prevSrc = previousButtonSrc;
        tv_nextSrc = forwardButtonSrc;
    ...
    private void setAttributes(AttributeSet attrs) {
        ...
        try {
            ...
            mTodayLabelColor = typedArray.getColor(R.styleable.CalendarView_todayLabelColor,
                    ContextCompat.getColor(mContext, R.color.blue_highlight));
            ...
            if (previousButtonScr != null) {
                tv_prev.setBackground(previousButtonScr);
            }
            ...
            if (forwardButtonScr != null) {
                tv_next.setBackground(forwardButtonScr);
            }
    ...
    private void initAttributes() {
        ...
        if (tv_prevSrc != 0) {
            tv_prev.setBackground(getResources().getDrawable(tv_prevSrc));
        }

        if (tv_nextSrc != 0) {
            tv_next.setBackground(getResources().getDrawable(tv_nextSrc));
        }

        if (mSelectionColor != 0) {
            mSelectionColor = ContextCompat.getColor(mContext, mSelectionColor);
        } else {
            mSelectionColor = ContextCompat.getColor(mContext, R.color.blue_highlight);
        }

        if (mTodayLabelColor != 0) {
            mTodayLabelColor = ContextCompat.getColor(mContext, mTodayLabelColor);
        } else {
            mTodayLabelColor = ContextCompat.getColor(mContext, R.color.blue_highlight);
        }
    ...
    private void initUiElements() {
        ...
        tv_next.setOnClickListener(onNextClickListener);

        tv_prev = findViewById(R.id.tv_prev);
        tv_prev.setOnClickListener(onPreviousClickListener);
        ...
        */
        ...
        mCurrentMonthLabel = findViewById(R.id.tv_dateLabel);
    ...
    public static class Builder {
        ...
        public CalendarView build() {
            return new CalendarView(mContext, mIsDatePicker, mHeaderColor, mHeaderLabelColor,
                    tv_prevSrc, tv_nextSrc, mSelectionColor, mTodayLabelColor,
