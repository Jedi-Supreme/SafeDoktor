...
public class Biography {
    ...
    public Biography(String fn, String ln, int gender, String country_code, String mobile_number,
                     String date_of_birth, int marital_state){
        firstname = fn;
        lastname = ln;
        this.gender = gender;
    ...
    public Biography(String firebase_Uid, String opd_Id, String fn, String ln, int gender, String country_code,
                     String mobile_number, String email, String date_of_birth, int marital_state){
